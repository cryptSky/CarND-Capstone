...
if("FALSE" STREQUAL "TRUE")
  set(tl_detector_SOURCE_PREFIX /home/cryptsky/CarND-Capstone/ros/src/tl_detector)
  set(tl_detector_DEVEL_PREFIX /home/cryptsky/CarND-Capstone/ros/devel)
  ...
  set(tl_detector_INSTALL_PREFIX /home/cryptsky/CarND-Capstone/ros/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tl_detector' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cryptsky/CarND-Capstone/ros/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/cryptsky/CarND-Capstone/ros/install/lib;/home/cryptsky/CarND-Capstone/ros/devel/lib;/opt/ros/melodic/lib)
...
set(depends "geometry_msgs;roscpp;rospy;sensor_msgs;std_msgs;styx_msgs")
